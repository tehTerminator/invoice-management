<!--::START:: customerTable.php-->
<table class="ui sortable striped very compact table" data-source="customers" data-type="autoFill" data-sortable="true">
	<thead>
		<tr>
